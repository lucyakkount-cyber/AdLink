    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (data?.error === "User not found or password incorrect") {
          throw new Error("Biznes akkaunti topilmadi. Iltimos, avval ro'yxatdan o'ting.")
        }
        throw new Error(data?.error || "Login failed")
      }

      // Get user role after login and verify it's business
      ...
      if (me.role !== "business") {
        ...
        throw new Error("Bu email biznes akkauntiga tegishli emas. Bloger akkaunti uchun boshqa login sahifasidan foydalaning.")
      }
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10 lg:px-6 lg:py-16">
      ...
      <p className="mt-1 text-muted-foreground">
        Blogerlarni toping va reklamalarni yarating
      </p>
      ...
      <div className="mt-6 rounded-2xl border border-border bg-background p-6 shadow-sm">
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <Button
            ...
            disabled={loading}
          >
            {loading ? "Kirilmoqda..." : "Biznes akkauntiga kirish"}
          </Button>
